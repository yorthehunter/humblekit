...
;
/* http://prismjs.com/download.html?themes=prism&languages=css+clike+javascript+coffeescript+scss+ruby&plugins=line-numbers */
...
(function() {
  var keyTriggers, showContainerSize;

  $(function() {
    var animation_width, duration_fast, duration_medium, duration_slow, offset;
    ...
    $('.js-affix').each(function() {
      var affix, affixTop, affixWidth, originalWidth;
      affix = $(this);
      ...
      return affix.css({
        ...
        return affix.width(affixWidth);
      }).on("affix-top.bs.affix", function() {
        affix.width(null);
        return affix.css("width", originalWidth);
      });
    });
    $(window).resize(function() {
      return showContainerSize();
    });
    $(".js-clickable-letter").css("cursor", "pointer").click(function() {
      var e, keycode;
    ...
    $(window).scroll(function() {
      if ($(this).scrollTop() > offset) {
        return $(".js-back-to-top").stop(false, false).animate({
          right: "-1px"
        }, duration_fast);
      } else {
        return $(".js-back-to-top").stop(false, false).animate({
  ...
  showContainerSize = function() {
    ...
    return $(".js-container-width").text(container + " (" + width + "px)");
  };

  keyTriggers = function(e) {
    var key;
    key = e.which;
    switch (key) {
      case 104:
      ...
      case 106:
        return $(".grid").toggleClass("bg-grid-test");
      case 107:
        return $(".js-site-help").stop(true).slideToggle("fast");
    }
  };
